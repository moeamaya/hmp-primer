(() => {
  ...
  var dragMoveListener = (event) => {
    ...
    var x = (parseFloat(target2.getAttribute("data-x")) || 0) + event.dx;
    var y = (parseFloat(target2.getAttribute("data-y")) || 0) + event.dy;
    target2.style.transform = "translate(" + x + "px, " + y + "px)";
    target2.setAttribute("data-x", x);
    target2.setAttribute("data-y", y);
  };
  var updateScroll = () => {
