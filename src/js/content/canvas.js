    ...
    <div class="canvas-zoom">
      <div id="svg" style="${artboardStyle}">
        <svg id="wavma-svg" width="500" height="300" viewBox="0 0 500 300" fill="none" xmlns="http://www.w3.org/2000/svg" style="${svgStyle}">
          ...
          <text fill="black" xml:space="preserve" style="white-space: pre" font-family="sans-serif" font-size="38" letter-spacing="0em"><tspan x="39" y="69.8182">Copal</tspan><tspan x="39" y="115.818">Dimensions</tspan><tspan x="39" y="161.818">Dwellito</tspan><tspan x="39" y="207.818">Mythopedia</tspan><tspan x="39" y="253.818">Wavma</tspan></text>
        </svg>
      </div>
    </div>
    </div>
